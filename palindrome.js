...
var optDiv = document.querySelector("#result");
var showMessage = document.querySelector("#result");
...
function checkPallindrome(dd) {
    ...
    if (flag) {
        ...
        showMessage.innerHTML = ("Awww! Your birthdate is not palindrome. Nearest palindrome date is " + nextDate + " You missed it by " + daysAhead + " days.");
        optDiv.style.display = "block";
    }
}
